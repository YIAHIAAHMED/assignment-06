...
const StatusSection = () => {
    return (
        <div className='w-full lg:max-w-7xl md:mx-auto sm:mx-auto md:justify-center lg:min-h-[233px] md:h-auto sm:h-auto bg-gradient-to-r from-[#4F39F6] to-[#9514FA] mx-auto flex flex-col md:flex-row justify-center items-center gap-8 md:gap-12 lg:gap-20 px-6 md:px-10 lg:px-20 py-10 md:py-0 text-white'>
